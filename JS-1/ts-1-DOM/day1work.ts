...
const userarea : HTMLDivElement = document.getElementById("userName") as HTMLDivElement
...
// }
 ...
 const userLoginfunction = () : void => {
    user1.loggedIn = true;
    userarea.innerHTML = 'Welcome!!!'

}

const userLoginUser = (user3: user) : void => {
    user3.loggedIn = true;
    console.log(user3);
